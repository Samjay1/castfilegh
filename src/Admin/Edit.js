...
class  EditForm extends Component{
    constructor(){
        super()
        this.state={
            IMAGE_URL: 'https://apicastfilegh.votellaverify.com',
            BASE_URL: 'https://apicastfilegh.votellaverify.com/organiser',
            ...
            resValue1:'',resValue2:'',resValue3:'',resValue4:'',resValue5:'',resValue6:'',resValue7:'',resValue8:'',resValue9:'',resValue11:'',
        ...
        let getFormData = (form_id)=>{
            ...
            .then((response)=>{
                ...
                this.setState({
                    ...
                    resValue1:data.rv1!=='null'? data.rv1:'',resValue2:data.rv2!=='null'? data.rv2:'',
                    resValue3:data.rv3!=='null'? data.rv3:'',resValue4:data.rv4!=='null'? data.rv4:'',
                    resValue5:data.rv5!=='null'? data.rv5:'',resValue6:data.rv6!=='null'? data.rv6:'',
                    resValue7:data.rv7!=='null'? data.rv7:'',resValue8:data.rv8!=='null'? data.rv8:'',
                    resValue9:data.rv9!=='null'? data.rv9:'',resValue11:data.rv11!=='null'? data.rv11:'',
                    ...
                    null}
                        ...
                        <div className='grid lg:grid-cols-2 gap-2 border  lg:p-5  rounded-xl'>
                            ...
                            <div className='flex justify-between font-bold'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType1!=='null'? this.state.resType1 ? this.state.resType1:'' : ''}`} questionName={'resp1'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                ...
                                <div>
                                    ...
                                    <div className='py-2'>
                                        <a className='bg-blue-100 border border-blue-500 text-blue-600 rounded-lg hover:bg-blue-500 hover:text-white p-1 px-2' href="https://apicastfilegh.votellaverify.com/public/List.xlsx">Download Sample</a>
                                    </div>
                               </div>
                                </div>: null}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType2!=='null'? this.state.resType2 ? this.state.resType2:'' : ''}`} questionName={'resp2'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                        ...
                        <div className=' col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType3!=='null'? this.state.resType3 ? this.state.resType3:'' : ''}`} questionName={'resp3'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType4!=='null'? this.state.resType4 ? this.state.resType4:'' : ''}`} questionName={'resp4'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType5!=='null'? this.state.resType5 ? this.state.resType5:'' : ''}`} questionName={'resp5'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType6!=='null'? this.state.resType6 ? this.state.resType6:'' : ''}`} questionName={'resp6'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType7!=='null'? this.state.resType7 ? this.state.resType7:'' : '' }`} questionName={'resp7'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType8!=='null'? this.state.resType8 ? this.state.resType8:'' : '' }`} questionName={'resp8'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType9!=='null'? this.state.resType9 ? this.state.resType9:'' : ''}`} questionName={'resp9'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
                            ...
                            <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                                ...
                                <Dropdown question={`Select Response type: ${this.state.resType11!=='null'? this.state.resType11 ? this.state.resType11:'' : ''}`} questionName={'resp11'} onValueChange={this.onChangeRes} answers={['TEXT', 'TEXTAREA','NUMBER', 'RADIO', 'DROPDOWN', 'CHECKBOX','Date']} />
                                {/* for getting extra response values for checkbox, radio and dropdown res types */}
